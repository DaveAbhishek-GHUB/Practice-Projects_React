...
function WeatherLoader() {
  return (
    <>
      <div className="absolute left-1/2 top-1/2 -ml-[55px] -mt-[100px] h-[110px] w-[110px]">
        <svg
        ...
        >
          <g>
            <path
              className="fill-none stroke-[#9ea1a4] stroke-[0.25]"
        ...
        >
          <path
            className="fill-[#efefef] stroke-[#9ea1a4] stroke-[0.25]"
        ...
        <div className="absolute w-[70px] h-[70px] -mt-8 ml-[19px]">
          {[...Array(10)].map((_, i) => (
            <span
              key={i}
              className="opacity-100 bg-[#9ea1a4] block float-left w-[3px] h-[10px] ml-1 rounded-b-md animate-drop"
              style={{ animationDelay: `${-130 * (i + 1)}ms` }}
            ></span>
          ))}
        </div>

        <div className="font-sans tracking-wide text-center -ml-[43px] font-bold mt-5 text-xs text-[#a0a0a0] w-[200px]">
